...
@Vigilant('IQ/features/kuudra/splits', `§d§lKuudra Splits`, {
...
*/
  ...
  constructor() {
    ...
    this.setCategoryDescription('General', '§d§lGeneral stuff!');

    //Color
    this.setCategoryDescription('Color', '§d§lColor stuff');
